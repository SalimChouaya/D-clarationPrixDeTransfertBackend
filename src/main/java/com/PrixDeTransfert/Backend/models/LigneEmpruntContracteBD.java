...
@Entity
@Table
public class LigneEmpruntContracteBD {
	...
	public String getEmpruntsInterets() {
		return EmpruntsInterets;
	}
	public void setEmpruntsInterets(String empruntsInterets) {
		EmpruntsInterets = empruntsInterets;
	}
