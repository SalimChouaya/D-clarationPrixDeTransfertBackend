...
@Entity
@Table
public class LigneOperationFinanciereBD {
	 @Id
	...
	public void setInformationsOperationsFinancieres(InformationsOperationsFinancieresBD informationsOperationsFinancieres) {
	 ...
	 @ManyToOne
	    @JsonBackReference
	    @JoinColumn(name ="InformationsOperationsFinancieresid", referencedColumnName = "id")
